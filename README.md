...
TO DO:
- example with Data.AddressBook.Validation module using the V (Array String) applicative functor  https://book.purescript.org/chapter7.html#applicative-validation-1 (use `withError` operator to get useful errors)
